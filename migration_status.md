...
## Completed
 ...
 - [x] Action execution behavior parity: actions now transform and replace the selected clip entry first (normalizing to string clipboard content), sync the replacement to pasteboard, and only synthesize paste when invoked in explicit paste context
